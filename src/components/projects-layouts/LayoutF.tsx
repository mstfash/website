...
const LayoutF: React.FC<LayoutAProps> = ({ project, onBackClick }) => {
  return (
    <div className="relative min-h-screen shadow-[-8px_0_6px_0_rgba(0,0,0,0.3)] ">
      ...
      <div className="w-full ">
        ...
        <div className="md:p-8 ">
          ...
          {/* الصور 2 و 3 في صف واحد */}
          {project.fields?.projectImages?.[1]?.fields?.file?.url &&
          ...
          {project.fields?.projectImages?.[5]?.fields?.file?.url && (
            <div className="w-full md:w-1/2 ml-auto p-10 ">
              <img
